...
class NPSController extends Controller
{
    ...
    {
        /*if(!Auth::user()->can('viewAny', NPS::class)) {
    ...
    {
        /*if (!Auth::user()->can('create', NPS::class)) {
            return response()->json(['error' => 'Sin autorización.', 'success' => false], 403);
        }*/
        ...
        $modelo->id_ticket = $request->id_ticket;
        $modelo->evaluation = $request->evaluation;
